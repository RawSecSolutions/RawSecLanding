...
export const RAWSEC_I18N = {
  es: {
    ...
    services: {
      ...
      items: [
        { icon: 'code', title: 'Desarrollo a medida',
          desc: 'Plataformas web, e-commerce e integraciones con stack moderno, listas para escalar.',
    ...
    services: {
      ...
      items: [
        { icon: 'code', title: 'Custom development',
          desc: 'Web platforms, e-commerce and integrations on a modern stack, built to scale.',
