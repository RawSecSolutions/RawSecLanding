  ...
  services: {
    ...
    items: [
      { icon: 'code', title: 'Desarrollo de software a medida',
        desc: 'Construimos tu plataforma de cero: apps web, LMS, e-commerce, integraciones con APIs y dashboards. Desde el diseño hasta el despliegue en producción.',
      ...
      { icon: 'shield', title: 'Ciberseguridad certificada',
        desc: 'Pentesting y auditorías con metodología certificada. Encontramos las vulnerabilidades antes que un atacantey entregamos el reporte para cerrarlas.',
